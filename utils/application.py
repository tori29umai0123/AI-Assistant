...
class Application(TkinterDnD.Tk):
    ...
    def generate_image_anime_shadow(self):
        ...
        mode = "anime_shadow"
        output_pil = create_and_save_images(self.fastapi_url, prompt, nega, white_base_pil, invert_pil, shadow_line_pil, image_size, self.anime_shadow_output_path, mode, image_fidelity, lineart_fidelity)
        self.display_output_image(output_pil)
