...
exclude_folders = [
    ...
    os.path.join(target_directory, "AI_Assistant_modules"),
    os.path.join(target_directory, "utils"),   
]

# 新しいファイルの追加に加えて既存のコピー機能
files_to_copy = {
    os.path.join(target_directory, "AI_Assistant_modules/config_states.py"): os.path.join(target_directory, "modules/config_states.py"),
    os.path.join(target_directory, "AI_Assistant_modules/gitpython_hack.py"): os.path.join(target_directory, "modules/gitpython_hack.py"),  
    os.path.join(target_directory, "AI_Assistant_modules/launch_utils_AI_Assistant.py"): os.path.join(target_directory, "modules/launch_utils_AI_Assistant.py"),
    os.path.join(target_directory, "AI_Assistant_modules/sdxl_clip.py"): os.path.join(target_directory, "ldm_patched/modules/sdxl_clip.py"),
    os.path.join(target_directory, "AI_Assistant_modules/sd1_clip.py"): os.path.join(target_directory, "ldm_patched/modules/sd1_clip.py"),
    os.path.join(target_directory, "AI_Assistant_modules/sd2_clip.py"): os.path.join(target_directory, "ldm_patched/modules/sd2_clip.py"),
    os.path.join(target_directory, "AI_Assistant_modules/shared_cmd_options.py"): os.path.join(target_directory, "modules/shared_cmd_options.py"),
    os.path.join(target_directory, "AI_Assistant_modules/ui_extensions.py"): os.path.join(target_directory, "modules/ui_extensions.py"),    
}
